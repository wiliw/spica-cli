...
import { autoDetectProject, loadProjectConfig } from '../utils/projectConfig';
import { LAIN_COLORS } from './ui/colors';
// 执行 init 命令
export async function runInit(workspace, options = {}) {
...
// 分析代码架构
async function analyzeArchitecture(workspace) {
    const result = {
        mainEntry: undefined,
        keyFiles: [],
        modules: [],
...
// 构建 AGENTS.md 内容
function buildAgentsContent(config, architecture, workspace) {
