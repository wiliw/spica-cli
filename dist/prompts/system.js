...
export function buildSkillsSection(skillsMetadata) {
    if (!skillsMetadata)
        return '';
    return `
## Available Skills
...
export function getCompactPrompt(messagesText) {
